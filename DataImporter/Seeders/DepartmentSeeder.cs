...
namespace DataImporter.Seeders
{
    internal class DepartmentSeeder
    {
        ...
        public static void SeedDepartment(List<List<string>> data)
        {
            ...
            {
                var entity = _db.Departments.FirstOrDefault(u => u.Name == nameDepartments[i]);
                ...
                if (entity != null)
                {
                    ...
                    {
                        entity.ParentID = _db.Departments.FirstOrDefault(u => u.Name == parentDepartNames[i]).ID;
                    }
                ...
                var dep = _db.Departments.FirstOrDefault(u => u.Name == parentDepartNames[i]);
